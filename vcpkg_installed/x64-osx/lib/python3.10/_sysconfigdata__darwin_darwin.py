...
build_time_vars = {'ABIFLAGS': '',
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': 'not/existing/x64-osx-rel/coverage.info',
 'COVERAGE_REPORT': 'not/existing/x64-osx-rel/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. '
             '-I./../src/v3.10.7-a83fe77705.clean/Include -isysroot '
             '/Library/Developer/CommandLineTools/SDKs/MacOSX11.1.sdk -DNDEBUG '
             '-isysroot '
             '/Library/Developer/CommandLineTools/SDKs/MacOSX11.1.sdk -DNDEBUG',
 ...
 'TCLTK_INCLUDES': '-I' + _base + '/lib/pkgconfig/../../include '
 ...
 'abs_builddir': 'not/existing/x64-osx-rel',
 'abs_srcdir': 'not/existing/x64-osx-rel/./../src/v3.10.7-a83fe77705.clean',
 'datarootdir': '' + _base + '/share/python3',
 'exec_prefix': '' + _base + '',
 'prefix': '' + _base + '',
