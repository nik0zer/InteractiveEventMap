...
// Редактирование полей ивентов
// Прогресс бар
// About - описание нашего великолепного приложения
// На сервере сделать передачу порта из командной строки
// Клиент - окошко setting, где вводится ip и порт
// Авторизацию (хещ) + потереть кредс и запрашивать у сервера (сделать добавление через отсылку команды на сервер)
